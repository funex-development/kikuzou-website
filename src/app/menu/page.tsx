...
const courses = [
    {
        ...
        items: "【 メニュー内容 】 八寸／お造り／椀物／焚合せ／蒸し物／焼物／揚げ物／食事／デザート（季節やコースにより若干の変更有）",
        note: "",
    ...
    },
    {
        ...
        prices: ["¥7,700"],
        items: "【 メニュー内容 】 八寸／お造り／きのこ鍋／蒸し物／焼物／揚げ物／食事／デザート",
    ...
    },
    {
        ...
        name: "牡丹鍋コース",
        description:
            "信州の冬の味覚、猪肉を使用した牡丹鍋。滋味深い猪肉と季節の野菜を特製の味噌出汁でお楽しみください。",
        prices: ["¥7,700"],
        items: "【 メニュー内容 】 八寸／お造り／牡丹鍋／蒸し物／焼物／揚げ物／食事／デザート",
        note: "時期 12月〜3月",
    ...
    },
    {
        ...
        name: "河豚コース",
        description:
            "九州直送の最高級トラフグを使用。てっさ、ふぐちり、ふぐから揚げ、白子焼きなど、新鮮なトラフグを存分にご堪能ください。",
        prices: ["¥11,000", "¥13,200"],
